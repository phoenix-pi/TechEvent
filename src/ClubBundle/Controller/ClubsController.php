...

{
    ...
    public function newAction(Request $request,$id)
    {
        ...
        $Club = new Club();
        $Club->setClubName($request->get('name'));
        $Club->setClub_Description($request->get('desc'));
        $Club->setFacebook($request->get('fb'));
        $Club->setEmail($request->get('mail'));
    ...
    public function findClubAction(Request $request,$name)
    {
        $rech = $this->getDoctrine()->getRepository(Club::class)->FindByNameClub($name);
        $serializer = new Serializer([new ObjectNormalizer()]);
    ...
    {
        $em = $this->getDoctrine()->getManager();
        $c=$em->getRepository(Club::class)->find($id);

        $c->setClub_Status($request->get('stat'));
        $em->flush();
        $serializer = new Serializer([new ObjectNormalizer()]);
    ...
    public function findClubActionWeb(Request $request)
    {
        $Clubs="";
        $themes = $this->getDoctrine()->getRepository(Theme::class)->findAll();
        $owner= $this->getUser();
